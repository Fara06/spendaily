...
import {LayoutGrid,Wallet,PiggyBank,BarChart3,Plus,Settings,LogOut, Trophy,} from "lucide-react";
                ...
                {navItems.map(({ label, icon: Icon, href }) => {
                    ...
                    return (
                        <motion.a
                            ...
                            href={href}
                            whileHover={{ x: 4 }}
                            className={`flex items-center gap-3 rounded-full px-6 py-3 font-medium transition-all ${
                                isActive
